...
function App() {
  ...
  return (
    <div className="App">
      <a href='https://github.com/Melih00/ClickGame/tree/main/clickgame' rel="noreferrer" target='_blank'><img title='GITHUB' alt='github image' src='git-img.png' id='gitimg'/></a>
